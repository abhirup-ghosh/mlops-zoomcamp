...
print('standard deviation of the predicted duration for this dataset:', np.std(df_result['predicted_duration']))
print('mean of the predicted duration for this dataset:', np.mean(df_result['predicted_duration']))
